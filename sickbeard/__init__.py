...
from providers import ezrss, tvtorrents, btn, nzbsrus, newznab, womble, thepiratebay, dtt, torrentleech, nzbx, iptorrents, omgwtfnzbs, nyaatorrents, frozenlayer, kat
...
NYAA = False
NYAATORRENTS_CATEGORY = None
NYAATORRENTS_FILTER = None
...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                NZBS, NZBS_UID, NZBS_HASH, EZRSS, KAT, TVTORRENTS, TVTORRENTS_DIGEST, TVTORRENTS_HASH, BTN, BTN_API_KEY, \
                DTT, DTT_NORAR, DTT_SINGLE, THEPIRATEBAY, THEPIRATEBAY_TRUSTED, THEPIRATEBAY_PROXY, THEPIRATEBAY_PROXY_URL, THEPIRATEBAY_BLACKLIST, TORRENTLEECH, TORRENTLEECH_USERNAME, TORRENTLEECH_PASSWORD, NYAA, NYAATORRENTS_CATEGORY, NYAATORRENTS_FILTER, FROZENLAYER, \
	...
	KAT = bool(check_setting_int(CFG, 'KAT', 'kat', 0))
        ...
        NYAATORRENTS_CATEGORY = check_setting_str(CFG, 'NYAATORRENTS', 'nyaatorrents_category', '1_0')
        NYAATORRENTS_FILTER = check_setting_str(CFG, 'NYAATORRENTS', 'nyaatorrents_filter', '0')
        
        FROZENLAYER = bool(check_setting_int(CFG, 'FROZENLAYER', 'frozen_layer', 0))
...
def save_config():
    ...
    new_config['NYAATORRENTS']['nyaatorrents_category'] = NYAATORRENTS_CATEGORY
    new_config['NYAATORRENTS']['nyaatorrents_filter'] = NYAATORRENTS_FILTER
    
    new_config['FROZENLAYER'] = {}
    new_config['FROZENLAYER']['frozen_layer'] = int(FROZENLAYER)
